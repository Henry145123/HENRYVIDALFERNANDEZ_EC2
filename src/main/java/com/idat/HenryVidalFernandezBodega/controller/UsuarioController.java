package com.idat.HenryVidalFernandezBodega.controller;
...
import com.idat.HenryVidalFernandezBodega.service.UsuarioService;
...
public class UsuarioController {
	...
	public ResponseEntity<Void> actualizar(@RequestBody UsuarioDTORequest usuario) {
		UsuarioDTOResponse u =service.obtenerUsuarioId(usuario.getId());
		if(u != null) {
